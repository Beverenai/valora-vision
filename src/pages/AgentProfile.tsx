              ...
              return (
                <section>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {team.map(member => (
                      <Card key={member.id} className="border-border/60 hover:shadow-md transition-shadow h-[220px]">
                        <CardContent className="p-5 h-full flex flex-col items-center justify-center text-center gap-3">
                          ...
                          {member.slug ? (
                            <Button size="sm" className="rounded-full text-xs" asChild>
                              <Link to={`/agentes/${professional.slug}/${member.slug}`}>
                                View Profile
                              </Link>
                            </Button>
                          ) : (
                            <Button size="sm" className="rounded-full text-xs" disabled>
                              View Profile
                            </Button>
                          )}
                        </CardContent>
