...
const ValuationTicketCard: React.FC<ValuationTicketCardProps> = ({
  ...
  const frontFace = (
    <div className={cardClasses}>
      {/* Main Section */}
      <div className={cn("flex-1 flex flex-col relative border-r-2 border-dashed border-foreground/15", mainPadding, <div className={cn("flex-1 flex flex-col relative border-r-2 border-dashed border-foreground/15", mainPadding, (mapExpanded || hasBuyInput) ? "overflow-visible" : "overflow-hidden")}>)}>
        {/* Hero Image */}
        <div className={cn(
